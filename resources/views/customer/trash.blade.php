            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form class="form-order" action="{{ route('customer.index') }}" method="GET">
                                <div class="input-group mb-3">
                                <select onchange="$('.form-order').submit()" class="form-select" name="order" id="">
                                    <option @selected(request()->order == 'desc') value="desc">New to Oldest</option>
